        ...
        <div class="d-flex align-items-center justify-content-center mb-4 carrusel-puntos overflow-auto py-2">
            <a href="/" class="text-decoration-none me-3">
                <button class="btn btn-sm btn-secondary rounded-circle"
                    style="width: 32px; height: 32px; background-color: var(--color-header); border:none;">
        ...
        <section class="agrupacion-contenido">
            <div class="d-flex justify-content-between align-items-end mb-4">
                <div>
                    ...
                    <p class="subtitulo text-white opacity-75 mb-0" style="font-size: 0.95rem;">Resultados:
                        {{ $libros->count() }}</p>
                </div>
            </div>
